...
void Settings::LoadDefaultsOrSave(std::string path)
{
	...
	settings["AntiAim"]["Yaw"]["dynamic"] = Settings::AntiAim::Yaw::dynamic;
	...
	settings["AntiAim"]["MoonWalk"] = Settings::AntiAim::moonwalk;

    settings["AntiAim"]["Custom"]["YawOne"]["mode"] = (int) Settings::AntiAim::Custom::YawOne::mode;
    settings["AntiAim"]["Custom"]["YawOne"]["angle"] = Settings::AntiAim::Custom::YawOne::angle;
    settings["AntiAim"]["Custom"]["YawOne"]["jitter_min"] = Settings::AntiAim::Custom::YawOne::jitterMin;
    settings["AntiAim"]["Custom"]["YawOne"]["jitter_max"] = Settings::AntiAim::Custom::YawOne::jitterMax;
    settings["AntiAim"]["Custom"]["YawOne"]["spin_factor"] = Settings::AntiAim::Custom::YawOne::spinFactor;
    settings["AntiAim"]["Custom"]["YawOne"]["is_static"] = Settings::AntiAim::Custom::YawOne::isStatic;
    settings["AntiAim"]["Custom"]["YawOne"]["slow_spin"] = Settings::AntiAim::Custom::YawOne::slowSpin;

    settings["AntiAim"]["Custom"]["YawTwo"]["mode"] = (int) Settings::AntiAim::Custom::YawTwo::mode;
    settings["AntiAim"]["Custom"]["YawTwo"]["angle"] = Settings::AntiAim::Custom::YawTwo::angle;
    settings["AntiAim"]["Custom"]["YawTwo"]["jitter_min"] = Settings::AntiAim::Custom::YawTwo::jitterMin;
    settings["AntiAim"]["Custom"]["YawTwo"]["jitter_max"] = Settings::AntiAim::Custom::YawTwo::jitterMax;
    settings["AntiAim"]["Custom"]["YawTwo"]["spin_factor"] = Settings::AntiAim::Custom::YawTwo::spinFactor;
    settings["AntiAim"]["Custom"]["YawTwo"]["is_static"] = Settings::AntiAim::Custom::YawTwo::isStatic;
    settings["AntiAim"]["Custom"]["YawTwo"]["slow_spin"] = Settings::AntiAim::Custom::YawTwo::slowSpin;
...
void Settings::LoadConfig(std::string path)
{
	...
	Settings::Aimbot::weapons = {
			{ ItemDefinitionIndex::INVALID, { false, false, false, Bone::BONE_HEAD, ButtonCode_t::MOUSE_MIDDLE, false, false, 1.0f, SmoothType::SLOW_END, false, 0.0f, false, 0.0f, true, 180.0f, false, 25.0f, false, false, 2.0f, 2.0f, false, false, false, false, false, false, false, false, 10.0f, false, false, false, 5.0f, false, 5.0f } },
	};
	...
	GetVal(settings["AntiAim"]["Yaw"]["dynamic"], &Settings::AntiAim::Yaw::dynamic);
	...
	GetVal(settings["AntiAim"]["MoonWalk"], &Settings::AntiAim::moonwalk);

    GetVal(settings["AntiAim"]["Custom"]["YawOne"]["mode"], (int*)& Settings::AntiAim::Custom::YawOne::mode);
    GetVal(settings["AntiAim"]["Custom"]["YawOne"]["angle"], &Settings::AntiAim::Custom::YawOne::angle);
    GetVal(settings["AntiAim"]["Custom"]["YawOne"]["jitter_min"], &Settings::AntiAim::Custom::YawOne::jitterMin);
    GetVal(settings["AntiAim"]["Custom"]["YawOne"]["jitter_max"], &Settings::AntiAim::Custom::YawOne::jitterMax);
    GetVal(settings["AntiAim"]["Custom"]["YawOne"]["spin_factor"], &Settings::AntiAim::Custom::YawOne::spinFactor);
    GetVal(settings["AntiAim"]["Custom"]["YawOne"]["is_static"], &Settings::AntiAim::Custom::YawOne::isStatic);
    GetVal(settings["AntiAim"]["Custom"]["YawOne"]["slow_spin"], &Settings::AntiAim::Custom::YawOne::slowSpin);

    GetVal(settings["AntiAim"]["Custom"]["YawTwo"]["mode"], (int*)& Settings::AntiAim::Custom::YawTwo::mode);
    GetVal(settings["AntiAim"]["Custom"]["YawTwo"]["angle"], &Settings::AntiAim::Custom::YawTwo::angle);
    GetVal(settings["AntiAim"]["Custom"]["YawTwo"]["jitter_min"], &Settings::AntiAim::Custom::YawTwo::jitterMin);
    GetVal(settings["AntiAim"]["Custom"]["YawTwo"]["jitter_max"], &Settings::AntiAim::Custom::YawTwo::jitterMax);
    GetVal(settings["AntiAim"]["Custom"]["YawTwo"]["spin_factor"], &Settings::AntiAim::Custom::YawTwo::spinFactor);
    GetVal(settings["AntiAim"]["Custom"]["YawTwo"]["is_static"], &Settings::AntiAim::Custom::YawTwo::isStatic);
    GetVal(settings["AntiAim"]["Custom"]["YawTwo"]["slow_spin"], &Settings::AntiAim::Custom::YawTwo::slowSpin);

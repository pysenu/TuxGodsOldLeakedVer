...
void Misc::RenderTab()
{
	...
	ImGui::Columns(2, NULL, true);
	{
		ImGui::BeginChild("Child1", ImVec2(0, 0), true);
		{
			...
			ImGui::NextColumn();
			ImGui::Checkbox("Circlestrafer", &Settings::CircleStrafer::enabled);
			SetTooltip("Makes you gain speed in circles");
			ImGui::NextColumn();
			UI::KeyBindButton(&Settings::CircleStrafer::key);
	...
	ImGui::NextColumn();
	{
		ImGui::BeginChild("Child2", ImVec2(0, 0), true);
		{
			...
			ImGui::NextColumn();
			{
				...
				SetTooltip("Prevents TuxGods visuals from appearing in screenshots taken");

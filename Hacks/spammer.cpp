...
std::vector<std::string> Settings::Spammer::KillSpammer::messages = {
		"$nick just got owned by TuxGods",
		"$nick forgot to turn on his cheat",
		"Sorry for the 1tap, $nick",
		"TuxGods just rekt $nick",
};
bool Settings::Spammer::RadioSpammer::enabled = false;
std::vector<std::string> Settings::Spammer::NormalSpammer::messages = {
		"TuxGods owns me and all",
		"Your Windows p2c sucks my TuxGods dry",
		"It's pCode fuckboi",
		"If i was cheating, I'd use TuxGods",
		"Stop crying, kids",
		">tfw no vac on Linux"
};

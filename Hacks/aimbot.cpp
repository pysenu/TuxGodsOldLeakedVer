...
float Settings::Aimbot::SpreadLimit::value = 5.0f;
...
QAngle RCSLastPunch;
C_BasePlayer* Aimbot::target = NULL;
...
void Aimbot::CreateMove(CUserCmd* cmd)
{
	...
	if (activeWeapon->GetNextPrimaryAttack() > globalVars->curtime)
		bulletTime = false;
	if (Settings::Aimbot::silent && (cmd->buttons & IN_ATTACK) && bulletTime)
	{
